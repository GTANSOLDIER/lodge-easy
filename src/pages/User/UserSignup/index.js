    ...
    <div className="">
      ...
      <div className="px-7 mt-8">
        ...
        <div className="flex flex-row items-center justify-between h-[45px] mt-4 rounded border-[1px] border-[#545454] w-full">
          ...
          />
          <AiOutlineEye className={showPwd ? "text-[24px] text-[#BDBDBD] w-[15%]" : "hidden"} onClick={() => setShowPwd(false)}/>
          <AiOutlineEyeInvisible className={showPwd ? "hidden" : "text-[24px] text-[#BDBDBD] w-[15%]"} onClick={() => setShowPwd(true)}/>
        </div>
      </div>
