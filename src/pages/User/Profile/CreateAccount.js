  ...
  return (
    <div className="pb-[80px]">
      ...
      <div className="w-full flex items-center justify-center mt-[20px]">
        <div
          className={`w-[132px] h-[132px] border-[5px] border-[#BDBDBD]
          } rounded-full flex items-center justify-center`}
        >
          <div className="w-[108px] h-[108px] bg-[#BDBDBD] bg-cover bg-center flex items-center justify-center rounded-full"></div>
        </div>
      </div>
