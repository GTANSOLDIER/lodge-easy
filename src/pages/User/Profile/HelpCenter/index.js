...
export default function HelpCenter() {
  ...
  return (
    <div>
      ...
      <div className="flex fixed top-[60px] items-center px-[30px] py-[20px] w-full border-b-[1px] border-b-[#E0E0E0]">
        <div className="w-[50px] h-[50px] mr-[15px] customerCareImg rounded-xl"></div>
        <div>
          <div className="font-golos font-semibold text-[16px]">ADM-123</div>
      ...
      <div className="py-[20px] mt-[90px] text-center mx-[30px] border-b-[1px] border-[#EAEAEA] font-nunito text-[14px] text-[#545454]">
        Oct 3, 2023
      </div>
      <div className="font-nunito text-[14px] text-center py-[20px] text-[#545454]">
        Chat started with Customer Care Agent
      </div>
      ...
      <div className="px-[30px] pb-[20px] fixed bottom-0 w-full flex justify-between items-center">
        ...
        <div className="flex items-center px-2 justify-between border-[1px] border-[#707070] rounded-md w-[70vw] h-[44px]">
          <textarea placeholder="Type a message..." className="h-[30px] w-[85%]" value={textValue} onChange={(e) => setTextValue(e.target.value)}/>
          <IoMdSend className="text-[24px]" onClick={() => {setMessages(oldArray => [...oldArray, {text: textValue}]); setTextValue("")}}/>
        </div>
      </div>
    </div>
  );
