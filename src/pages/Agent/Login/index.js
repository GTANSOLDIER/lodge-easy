  ...
  return (
    <div className="">
      ...
      <div className="px-7 py-8">
        ...
        <Link href="/Agent/Login/PendingApproval">
          <button className="h-[45px] mt-4 text-[14px] font-poppins font-medium text-white w-full bg-[#458CA2] rounded">
            Log In Unapproved
          </button>
        </Link>
      ...
      <div className="font-nunito text-[14px] font-normal text-center mt-[10vh] mb-20">
        ...
        <Link href="/Agent/Signup" className="text-[#458CA2]">
          Sign Up
        </Link>
      </div>
    </div>
