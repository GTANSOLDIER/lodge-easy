...
export default function AgentHostelItemOpen() {
    ...
    <div key={id}>
      ...
      <div className="px-[30px] w-full">
        <Link href="/Agent/Listings/CreateListing">
          <div className="mt-[24px] mb-[32px] w-full bg-[#458CA2] flex items-center justify-center text-white py-[8px] rounded-[5px]">
            <div>Edit</div>
            <MdOutlineModeEditOutline className="text-[18px] ml-[8px]"/>
          </div>
        </Link>
      </div>
    </div>
